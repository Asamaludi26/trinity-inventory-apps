...
export class RepairController {
  ...
  async approve(@Param('id', ParseUUIDPipe) id: string) {
    return this.repairService.approve(id);
  }
  ...
  async complete(
    ...
    return this.repairService.complete(id, data);
  }
  ...
  async cancel(
    ...
    return this.repairService.cancel(id, user.sub);
  }
}
